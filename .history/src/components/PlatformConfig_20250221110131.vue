  ...
  <div class="platform-config">
    ...
    <div class="config-grid">
      <div class="config-item">
        ...
        <input
          type="text"
          v-model="localValues.manifestVersion"
      ...
      <div class="config-item">
        ...
        <input
          type="text"
          v-model="localValues.platformVersion"
      ...
      <div class="config-item">
        ...
        <input
          type="text"
          v-model="localValues.platformImage"
      ...
      <div class="config-item">
        ...
        <input
          type="text"
          v-model="localValues.platformImageTag"
      ...
      <div class="config-item">
        ...
        <input
          type="text"
          v-model="localValues.platformAssetUrl"
      ...
      <div class="config-item full-width">
        ...
        <textarea
          v-model="localValues.moduleSourcesStr"
